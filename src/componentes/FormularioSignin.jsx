    ...
    <div className="flex flex-wrap flex-col justify-center items-center w-screen h-screen ">
      ...
      <div className="flex flex-row justify-center items-center bg-[#080C13] rounded-lg py-4 px-12 w-3/5">
        <div className="flex flex-col w-full items-center justify-center">
          <h2 className="my-4  text-center text-[30px] flex-wrap font-bold text-[#EBEBEC]">
      ...
      <p className='text-center text-[15px] flex-wrap font-bold text-[#FAFCFC]'>Unlimited fun awaits you...</p> */}
          <form onSubmit={signin} className="w-full">
            <div className="w-full mt-4 mr-0 mb-0 ml-0 space-y-6 flex flex-col items-center">
              ...
              <button
                type="submit"
                className="flex w-[70vw] md:w-[30vw] h-12 flex-col items-center justify-center shrink-0 rounded-[5px] hover:bg-zinc-950 border border-solid border-amber-300 bg-gradient-to-r from-amber-400 to-amber-700 transition-colors duration-500 hover:from-amber-400 hover:to-amber-600"
              >
              ...
              <GoogleLogin
                ...
                render={(renderProps) => (
                  <button
                    className="w-[70vw] md:w-[30vw] h-12 shrink-0 border rounded-[5px] hover:bg-zinc-950 border-solid border-white  flex justify-center items-center"
                    onClick={renderProps.onClick}
                    disabled={renderProps.disabled}
                  >
                    <img src="/public/Google.png" className="w-6 h-6 shrink-0" />
                    <p className="ms-2 text-[#EBEBEC] text-center text-sm not-italic font-medium leading-[normal] tracking-[0.7px]">Sign in with Google</p>
                  </button>
                )}
                buttonText="Login"
                onSuccess={onSuccess}
              ...
              <p className="text-[#EBEBEC] text-sm not-italic font-medium leading-[normal] tracking-[0.7px]">
                You dont have an account yet? <Anchor className="text-amber-400 hover:text-amber-300">Sign up</Anchor>
              </p>
              <p className="text-[#EBEBEC] text-sm not-italic font-medium leading-[normal] tracking-[0.7px]">
                Go back to{" "}
                <Anchor to={"/"} className="text-amber-400 hover:text-amber-300">
                  home page
                </Anchor>
              </p>
            </div>
